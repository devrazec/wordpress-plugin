...
jQuery(document).ready(function(){
    ...
    jQuery('#expert-gardener-demo-setup-guid .expert-gardener-setup-menu').attr("checked","checked");

    jQuery('#expert-gardener-setup-menu').click(function(){
        jQuery('#expert-gardener-demo-setup-guid .expert-gardener-setup-menu').css("display","block");
        jQuery('#expert-gardener-demo-setup-guid .expert-gardener-setup-contact').css("display","none");
        jQuery('#expert-gardener-demo-setup-guid .expert-gardener-setup-widget').css("display","none");
        jQuery('#expert-gardener-demo-setup-guid .expert-gardener-setup-social-icon').css("display","none");
    });

    jQuery('#expert-gardener-setup-contact').click(function(){
        jQuery('#expert-gardener-demo-setup-guid .expert-gardener-setup-menu').css("display","none");
        jQuery('#expert-gardener-demo-setup-guid .expert-gardener-setup-contact').css("display","block");
        jQuery('#expert-gardener-demo-setup-guid .expert-gardener-setup-widget').css("display","none");
        jQuery('#expert-gardener-demo-setup-guid .expert-gardener-setup-social-icon').css("display","none");
    });

    jQuery('#expert-gardener-setup-widget').click(function(){
        jQuery('#expert-gardener-demo-setup-guid .expert-gardener-setup-menu').css("display","none");
        jQuery('#expert-gardener-demo-setup-guid .expert-gardener-setup-contact').css("display","none");
        jQuery('#expert-gardener-demo-setup-guid .expert-gardener-setup-widget').css("display","block");
        jQuery('#expert-gardener-demo-setup-guid .expert-gardener-setup-social-icon').css("display","none");
    });

    jQuery('#expert-gardener-setup-social').click(function(){
        jQuery('#expert-gardener-demo-setup-guid .expert-gardener-setup-menu').css("display","none");
        jQuery('#expert-gardener-demo-setup-guid .expert-gardener-setup-contact').css("display","none");
        jQuery('#expert-gardener-demo-setup-guid .expert-gardener-setup-widget').css("display","none");
        jQuery('#expert-gardener-demo-setup-guid .expert-gardener-setup-social-icon').css("display","block");
    });
});