...
if ( ! class_exists( 'Tour_Planner_Ebooking_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Tour_Planner_Ebooking_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'tour_planner_ebooking_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function tour_planner_ebooking_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Tour_Planner_Ebooking_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'tour_planner_ebooking_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function tour_planner_ebooking_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Tour_Planner_Ebooking_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
