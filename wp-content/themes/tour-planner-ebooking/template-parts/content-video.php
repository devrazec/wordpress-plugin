...
<?php
  ...
  $tour_planner_ebooking_video = false;
  // Only get video from the content if a playlist isn't present.
  if ( false === strpos( $tour_planner_ebooking_content, 'wp-playlist-script' ) ) {
    $tour_planner_ebooking_video = get_media_embedded_in_content( $tour_planner_ebooking_content, array( 'video', 'object', 'embed', 'iframe' ) );
  }
?>
<?php 
    ...
    <div class="box-img">
      <?php
        if ( ! is_single() ) {
          ...
          if ( ! empty( $tour_planner_ebooking_video ) ) {
            foreach ( $tour_planner_ebooking_video as $tour_planner_ebooking_video_html ) {
              echo '<div class="entry-video">';
                echo $tour_planner_ebooking_video_html;
              echo '</div>';
            }
          };
        }; 
