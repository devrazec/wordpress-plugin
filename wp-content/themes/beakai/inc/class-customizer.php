...
class Beakai_Customizer_Class {
	...
	public function __construct($data) {
		$this->data = $data;
		add_action('customize_register',array($this,'beakai_customize_register'));
	...
	public function beakai_customize_register($customizeObj) {
...
add_action('init','Beakai_Customizer_Class::_data_load');
		...
		public function render_content() {
			...
			<label>
				...
				<div class="switch_options">
					<span class="switch_enable"><?php esc_html_e('Show','beakai'); ?></span>
					<span class="switch_disable"><?php esc_html_e('Hide','beakai'); ?></span>  
