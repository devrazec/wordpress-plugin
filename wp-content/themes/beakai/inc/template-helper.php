...
function beakai_breadcrumb_func()
{
    ...
    if (empty($is_breadcrumb) && $breadcrumb_show == 1) {
        ...
        <div class="breadcrumb-area breadcrumb-spacing <?php print esc_attr($breadcrumb_class); ?>" data-overlay="5" data-background="<?php print esc_attr($bg_img); ?>">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
...
function beakai_breadcrumb_bg_color()
{
    ...
    wp_enqueue_style('beakai-pheader-color', BEAKAI_THEME_CSS_DIR . 'beakai-custom.css', array());
    if ($color_code != '') {
        $custom_css = '';
        $custom_css .= ".breadcrumb-area { background: " . $color_code . "}";

        wp_add_inline_style('beakai-pheader-color', $custom_css);
    }
}
...
{
    $padding_px = get_theme_mod('beakai_pheader_top', __('100px', 'beakai'));
    wp_enqueue_style('beakai-pheader-top', BEAKAI_THEME_CSS_DIR . 'beakai-custom.css', array());
    if ($padding_px != '') {
        $custom_css = '';
        $custom_css .= ".breadcrumb-spacing { padding-top: " . $padding_px . "}";

        wp_add_inline_style('beakai-pheader-top', $custom_css);
    }
}
...
{
    $padding_px = get_theme_mod('beakai_pheader_bottom', __('100px', 'beakai'));
    wp_enqueue_style('beakai-pheader-bottom', BEAKAI_THEME_CSS_DIR . 'beakai-custom.css', array());
    if ($padding_px != '') {
        $custom_css = '';
        $custom_css .= ".breadcrumb-spacing { padding-bottom: " . $padding_px . "}";

        wp_add_inline_style('beakai-pheader-bottom', $custom_css);
    }
}
...
function beakai_scrollup_switch()
{
    ...
    wp_enqueue_style('beakai-scrollup-switch', BEAKAI_THEME_CSS_DIR . 'beakai-custom.css', array());
    if ($scrollup_switch) {
        $custom_css = '';
...
function beakai_logo_size()
{
    $logo_width = get_theme_mod('logo_size', __('', 'beakai'));
    wp_enqueue_style('beakai-logo-size', BEAKAI_THEME_CSS_DIR . 'beakai-custom.css', array());
    if ($logo_width != '') {
        $custom_css = '';
        $custom_css .= "header .logo img{ width: " . $logo_width . "}";

        wp_add_inline_style('beakai-logo-size', $custom_css);
    }
}
add_action('wp_enqueue_scripts', 'beakai_logo_size');
