			...
			'section' => array(
				...
				'header_main_setting' => array(
					...
					'fields' => array(
						...
						array(
							'name' => esc_html__('Logo Size', 'beakai'),
							'id' => 'logo_size',
							'default' => esc_html__('', 'beakai'),
							'transport'	=> 'refresh',
							'type' => 'text',
						),
						array(
				...
				'page_title_setting' => array(
					...
					'fields' => array(
						...
						array(
							...
							'id' => 'beakai_pheader_top',
							'default' => esc_html__('100px', 'beakai'),
							'transport'	=> 'refresh',
							'type' => 'text',
						),
						array(
							'name' => esc_html__('Breadcrumb Bottom Top', 'beakai'),
							'id' => 'beakai_pheader_bottom',
							'default' => esc_html__('100px', 'beakai'),
							'transport'	=> 'refresh',
							'type' => 'text',
						),
				...
				'cpt_slug_setting' => array(
					'name' => esc_html__('CPT Slug Setting', 'beakai'),
					'priority' => 20,
					'fields' => array(
						array(
							'name' => esc_html__('Service Name', 'beakai'),
							'id' => 'cpt_ser_name',
							'default' => esc_html__('Services', 'beakai'),
							'type' => 'text',
							'transport'	=> 'refresh'
						),
						array(
							'name' => esc_html__('Service Slug', 'beakai'),
							'id' => 'cpt_ser_slug',
							'default' => esc_html__('services', 'beakai'),
							'type' => 'text',
							'transport'	=> 'refresh'
						...
						array(
							'name' => esc_html__('Portfolio Name', 'beakai'),
							'id' => 'cpt_port_name',
							'default' => esc_html__('Portfolios', 'beakai'),
							'type' => 'text',
							'transport'	=> 'refresh'
						),
						array(
							'name' => esc_html__('Portfolio Slug', 'beakai'),
							'id' => 'cpt_port_slug',
							'default' => esc_html__('portfolio', 'beakai'),
							'type' => 'text',
							'transport'	=> 'refresh'
						)
					)
