...
if ( ! function_exists( 'tour_travel_agent_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function tour_travel_agent_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
...
if ( ! function_exists( 'tour_travel_agent_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function tour_travel_agent_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Tour_Travel_Agent_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
