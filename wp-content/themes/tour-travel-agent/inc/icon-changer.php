...
class Tour_Travel_Agent_Icon_Changer extends WP_Customize_Control{
      public $type = 'icon';
            ...
            <label>
                  ...
                  <ul class="icon-list">
                        <div class="social-icon-search">
                              <input class="socialInput" type="text" placeholder="<?php echo esc_attr('Search Icon', 'tour-travel-agent'); ?>">
                        </div>
                        <?php
                        $tour_travel_agent_font_awesome_icon_array = tour_travel_agent_font_awesome_icon_array();
                        foreach ($tour_travel_agent_font_awesome_icon_array as $tour_travel_agent_font_awesome_icon) {
                              $icon_class = $this->value() == $tour_travel_agent_font_awesome_icon ? 'icon-active' : '';
                              echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($tour_travel_agent_font_awesome_icon).'"></i>
                                    <span class="icons-class">'.esc_attr($tour_travel_agent_font_awesome_icon).'</span>
                              </li>';
                        }
                        ?>
                  </ul>
...
function tour_travel_agent_customizer_script() {
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/css/fontawesome-all.css');
}
add_action( 'customize_controls_enqueue_scripts', 'tour_travel_agent_customizer_script' );

if(!function_exists('tour_travel_agent_font_awesome_icon_array')){
    function tour_travel_agent_font_awesome_icon_array(){
        return array("None", 
            "fab fa-500px",
