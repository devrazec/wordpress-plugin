 ...
 */
/**
 * Class Tour_Travel_Agent_Customizer_Upsell_Section
 */
class Tour_Travel_Agent_Customizer_Upsell_Section extends WP_Customize_Section {
	/**
	...
	/**
	 * Tour_Travel_Agent_Customizer_Upsell_Section constructor.
	 */
	public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
		$manager->register_section_type( 'Tour_Travel_Agent_Customizer_Upsell_Section' );
