...
$config['page_slug'] 	= 'landscape-gardening';
...
$config['steps'] = array(
	'intro' => array(
		...
		'title'			=> __( 'Welcome to ', 'landscape-gardening' ) . $theme_title, // Section title
		'icon'			=> 'dashboard', // Uses Dashicons
		'button_text'	=> __( 'Start Now', 'landscape-gardening' ), // Button text
